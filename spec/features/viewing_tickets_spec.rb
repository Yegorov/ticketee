...
RSpec.feature "Users can view tickets" do
  ...
  scenario "for a given project" do
    ...
    expect(page).to_not have_content "Standards compilance"
    ...
    expect(page).to have_content "Gradients! Starburts!"
  end
end